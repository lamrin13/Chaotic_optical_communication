...
struct inp : public cadmium::in_port<Signal_t>{};
...
int main(){
    ...
    const char * i_input_data_control = "../input_data/synchronizer_test.txt";
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader, sync};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
            dynamic::translate::make_EOC<Synchronizer_defs::out,outp>("sync")
    };
    dynamic::modeling::ICs ics_TOP = {
            dynamic::translate::make_IC<iestream_input_defs<Signal_t>::out,Synchronizer_defs::in>("input_reader","sync")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/synchronizer_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/synchronizer_test_output_state.txt");
