...
int main(){
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader, gain1, bias1};
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/feedback_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/feedback_test_output_state.txt");
