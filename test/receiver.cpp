//
// Created by Nirmal on 2021-10-25.
//
...
int main(int argc, char ** argv) {
    ...
    const char * i_input = "../input_data/receiver_input.txt";
    ...
    dynamic::modeling::Models submodels_FB = {gain2, bias2};
    dynamic::modeling::EICs eics_FB = {
            cadmium::dynamic::translate::make_EIC<input_gain, Gain_defs::in>("gain2")
    };
    dynamic::modeling::EOCs eocs_FB = {
            dynamic::translate::make_EOC<Bias_defs::out,output_gain>("bias2")
    };
    ...
    dynamic::modeling::Models submodel_NLS = {FEEDBACK, modulator2};
    dynamic::modeling::EICs eics_NLS = {
            dynamic::translate::make_EIC<input_nls,Modulator_defs::in>("modulator2")
    };
    dynamic::modeling::EOCs eocs_NLS = {
            dynamic::translate::make_EOC<Modulator_defs::out,output_nls>("modulator2")
    };
    dynamic::modeling::ICs ics_NLS = {
            dynamic::translate::make_IC<Modulator_defs::out,input_gain>("modulator2","FEEDBACK"),
            dynamic::translate::make_IC<output_gain, Modulator_defs::in>("FEEDBACK","modulator2")
    };
    ...
    dynamic::modeling::Models submodel = {input_reader, NLS, subtractor};
    dynamic::modeling::EICs eics = {};
    dynamic::modeling::EOCs eocs = {
            dynamic::translate::make_EOC<Subtractor_defs::out,output>("subtractor")
    };
    dynamic::modeling::ICs ics = {
            dynamic::translate::make_IC<iestream_input_defs<Signal_t>::out,input_nls>("input_reader","NLS"),
            dynamic::translate::make_IC<iestream_input_defs<Signal_t>::out,Subtractor_defs::in1>("input_reader","subtractor"),
            dynamic::translate::make_IC<output_nls, Subtractor_defs::in2>("NLS","subtractor")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/receiver_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/receiver_output_state.txt");
