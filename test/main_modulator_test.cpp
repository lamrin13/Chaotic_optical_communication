...
int main(){
    ...
    const char * i_input_data_control = "../input_data/modulator_test.txt";
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader, modulator};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
            dynamic::translate::make_EOC<Modulator_defs::out,outp>("modulator")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/Modulator_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/Modulator_test_output_state.txt");
