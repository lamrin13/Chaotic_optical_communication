...
int main(){
    ...
    const char * i_input_data_control = "../input_data/channel_test.txt";
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader, channel};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
            dynamic::translate::make_EOC<Channel_defs::out,outp>("channel")
    };
    dynamic::modeling::ICs ics_TOP = {
            dynamic::translate::make_IC<iestream_input_defs<Signal_t>::out,Channel_defs::in>("input_reader","channel")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/channel_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/channel_test_output_state.txt");
